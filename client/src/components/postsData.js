...
const posts = [
  {
    ...
    content: [
      ...
      `• Emanuele Morais (Inteli)`,
      `• Solange Gueiros (Chainlink Developer)`,
      `…along with many others who made the experience even more special.`,
      ...
      `• João Rubens Belluzzo Neto (Impacta)`,
      `• Lucas Bispo de Oliveira (Head of Education at NearX)`,
      `• Marina Fuzeti (Senior PR Manager at Chiliz)`,
      ...
      `The Road to France was more than just a trip. It was the realization of a dream, a milestone in my personal and professional journey. I'm deeply thankful to everyone who was part of it — friends, mentors, organizers, sponsors, and the entire community.`,
      `If there's one thing I've learned, it's that the real prize isn't always the trophy — it's in the growth, connections, and experiences along the way.`,
